...
!(function (e) {
    ...
    function n(o, r) {
        var n = t.raw
            ...
            : (function e(o) {
                  ...
                  try {
                      return (
                          (o = decodeURIComponent(o.replace(i, " "))),
                          t.json ? JSON.parse(o) : o
                      );
                  } catch (r) {}
              })(o);
        return e.isFunction(r) ? r(n) : n;
    }
    var t = (e.cookie = function (i, c, u) {
        if (void 0 !== c && !e.isFunction(c)) {
            ...
            return (document.cookie = [
                o(i),
                "=",
                ((a = c), o(t.json ? JSON.stringify(a) : String(a))),
    ...
    (t.defaults = {}),
        (e.removeCookie = function (i, o) {
            return (
                void 0 !== e.cookie(i) &&
                (e.cookie(i, "", e.extend({}, o, { expires: -1 })),
                !e.cookie(i))
            );
        });
});
...
function swalConfirm(title = "Bạn có chắc chắn muốn thực thi?") {
    return swal
        .fire({
            title: title,
            text: "",
...
function swalError(title = "Thao tác thất bại!") {
    return swal.fire({ title: title, text: "", icon: "error" });
}
function swalSuccess(title = "Thao tác thành công!", html = "") {
    return swal.fire({ title: title, html: html, icon: "success" });
}
function swalLoading(title = "Vui lòng chờ", html = "") {
    return swal.fire({
        title: title,
        text: "",
        icon: "info",
...
function swalX(n) {
    var error = "Lỗi chưa xác định!";
    try {
        error = error.message
            ? error.message.toString()
            : n.responseJSON.message || n.statusText;
    } catch (n) {}
    swalError(error);
}
function swalInput(title, label = "", inputType = "number") {
    return new Promise((o) => {
        Swal.fire({
            ...
            confirmButtonText: "Đồng ý",
            cancelButtonText: "Không",
        }).then((n) => o(!(!n.isConfirmed || !n.value) && o(n.value)));
    });
}
function closeSwal() {
    swal.close();
}
function swalConfirmX(
    title = "Xác Nhận",
    text = "Bạn có chắc chắn muốn thực thi?"
) {
    return swal
        .fire({
            title: title,
